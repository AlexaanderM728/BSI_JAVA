...
public class Calculator {
    private double M_E = 2.71828;

    public double calcuate_01_03( double lambda , double time ) {
    ...
    public double calculate_01_04(double decimal_precentage, int time){
    ...
    public double[] calculate_01_05(double mtbf, double time){
    ...
    public double calculate_01_06(double mtbf, double time) {
    ...
    public double calculate_03_01(int machines, int allmachines, double time, int sum){
        double alltime = (double) sum +(time * ((double) allmachines- machines)); // half of the formula to calculate failures occurred (adds h failure motors and survived muliply by test h).
        double result =  (machines*(1.0/alltime));
        return  result;
     }

    //Content of tasks
    public void text1(){ // void function displays the content of the task
    ...
    public void text2(){// void function displays the content of the task
    ...
    public void text3(){// void function displays the content of the task
    ...
    public void text4(){// void function displays the content of the task
    ...
    public void text5(){// void function displays the content of the task
        ...
        while(true){
            ...
            switch(task){
                case 1:
                    ...
                    calculator.text1();// void function displays the content of the task
                    ...
                    System.out.println("The reliability is "+ calculator.calcuate_01_03(lambda, time)+"%\n");
                    break;
                case 2:
                    System.out.println("01.04\n");
                    calculator.text2();// void function displays the content of the task
                    ...
                    System.out.println("The highest failure rate for a product if it is to have a reliability (or probability of survival) of "+
                            decimal_precentage +" at "+time+" is equal to " +calculator.calculate_01_04(decimal_precentage, (int) time)+"\n");
                    break;
                case 3:
                    System.out.println("01.05\n");
                    calculator.text3();// void function displays the content of the task
                    ...
                    double[] values =  calculator.calculate_01_05(mtbf, time);
                ...
                case 4:
                    ...
                    calculator.text4();// void function displays the content of the task
                    System.out.println("Enter MTBF value (X):\n");
                    try {
                        mtbf = sc.nextDouble();
                    }catch(InputMismatchException e){
                    ...
                    System.out.println("If MTBF is equal to "+ mtbf + "\nThe probability that the equipment will operate for a period of " +(int) time +" hours without failure is equal to "+calculator.calculate_01_06(mtbf, time)+"\n");
                    break;
                case 5:
                    System.out.println("03.01\n");
                    calculator.text5();// void function displays the content of the task
                    ...
                    for( int i = 0; i < machines; i++) { // for loop to insert values to array
                        ...
                        int b = sc.nextInt(); // variable B is used to write user data into the array.  The array holds the values provided by the user.
                        a[i] = b ;
                    }
                    for( int j = 0; j < machines; j++ ) { // a loop for counting sums.
                        sum += a[j];
                    }
                    System.out.println(calculator.calculate_03_01(machines, allmachines, time, sum) + " failures/h");
                    break;
                case 6:
                    System.exit(0);
                default:
